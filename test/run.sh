...
for suite in verify crosscheck audit-fixes pillar3 pension-service health-coverage cash-reserve mortgage-spending pension-lump-sum monotonic invariants roundtrip output; do
  node "test/$suite.mjs"
done
