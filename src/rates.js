...
export const RATES = {
  ...
  protection: {
    ...
    investorCompensation: 20_000,       // eligible missing-asset claims, not market losses
  },
  ...
  marketRates: {
    ...
    ecbSource: 'https://www.ecb.europa.eu/stats/policy_and_exchange_rates/key_ecb_interest_rates/html/index.en.html',
    moneyMarketFundNet: 0.022,        // unverified legacy nominal scenario, before personal tax; not a live quote
  },
};
